...
$ignoreErrors[] = [
    'message' => '#^Class App\\\\Models\\\\Chapter uses generic trait Illuminate\\\\Database\\\\Eloquent\\\\Factories\\\\HasFactory but does not specify its types\\: TFactory$#',
    'identifier' => 'missingType.generics',
    'count' => 1,
    'path' => __DIR__.'/app/Models/Chapter.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Method App\\\\Models\\\\MediaFile\\:\\:chapters\\(\\) return type with generic class Illuminate\\\\Database\\\\Eloquent\\\\Relations\\\\HasMany does not specify its types\\: TRelatedModel, TDeclaringModel$#',
    'identifier' => 'missingType.generics',
    'count' => 1,
    'path' => __DIR__.'/app/Models/MediaFile.php',
];
